...
(function(){
  ...
  bar.innerHTML = '<span>We use cookies to enhance your experience. See our <a href="cookies.html" style="color:#075985;">Cookie Policy</a> and <a href="privacy-policy.html" style="color:#075985;">Privacy Policy</a>.</span>'
    +'<div style="display:flex;gap:8px;">'
    +'<button id="cc-accept-all" style="background:#0284c7;color:#fff;border:none;padding:8px 18px;border-radius:4px;cursor:pointer;font-weight:700;">Accept All</button>'
